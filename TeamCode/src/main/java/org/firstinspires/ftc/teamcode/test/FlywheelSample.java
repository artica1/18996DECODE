...
public class FlywheelSample extends LinearOpMode {
    ...
    public static int setPointVelocity = -1500;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        flywheel = new MotorEx(hardwareMap, HardwareMapNames.SHOOTER_MOTOR, Motor.GoBILDA.BARE);
        ...
        while (!isStopRequested() && opModeIsActive()) {
            ...
            if (gamepad1.cross) {
                ...
                flywheel.setVelocity(setVelocity);
            } else {
                setVelocity = 0;
                flywheel.setVelocity(setVelocity);
            }
            ...
            panelsTelemetry.addData("Current Velocity", velocity);
            panelsTelemetry.addData("Setpoint Velocity", setVelocity);
